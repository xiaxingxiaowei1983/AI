...
/awkn-xhs-images posts/ai-future/article.md

# Specify style
/awkn-xhs-images posts/ai-future/article.md --style notion

# Specify layout
/awkn-xhs-images posts/ai-future/article.md --layout dense

# Combine style and layout
/awkn-xhs-images posts/ai-future/article.md --style tech --layout list
...
/awkn-xhs-images --style bold --layout comparison
[paste content]
```
...
1. `.awkn-skills/awkn-xhs-images/EXTEND.md` (project)
2. `~/.awkn-skills/awkn-xhs-images/EXTEND.md` (user)
