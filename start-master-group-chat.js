...
console.log('Starting Grand Master Agent (大宗师智能体) with Group Chat Prompt...');
console.log('Using config:', './agents/master/openclaw.json');
console.log('Using prompt:', './agents/master/agent-group-chat.prompt');

const claw = new OpenClaw({
  configPath: './agents/master/openclaw.json',
  promptPath: './agents/master/agent-group-chat.prompt',
...
console.log('Grand Master Agent (大宗师智能体) with Group Chat Prompt is ready!');
