...
export interface UserDrawing {
  ...
  method: 'upload' | 'draw';
  timestamp: number;
  age?: string | number; // 用户年龄（可选）
  gender?: string; // 用户性别（可选）
}
...
export const mockRiskResult: AnalysisResult = {
  ...
  riskAssessment: {
    level: 'high',
    indicators: [
      '极端的虚无感表现：房子无屋顶、无门窗，树木无叶且树干极度细弱',
      '明显的自我贬低倾向：人物过小，远小于房子和树木',
      '明显的情绪压抑：人物无表情，房子无烟囱'
    ],
    suggestions: '立即寻求专业心理咨询师或精神科医生的帮助，全国心理援助热线：400-161-9995'
  }
};